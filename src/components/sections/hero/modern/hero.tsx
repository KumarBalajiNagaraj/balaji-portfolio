...
function Hero() {
  ...
  const handleTouch = () => {
    ...
    setTimeout(() => setVisible(false), 1500); // Reset after 1.5 seconds
  };
    ...
    >
      ...
      <div className="relative z-10 h-[42.5dvh] md:h-[51.2dvh] md:min-h-[50dvh] xl:h-[61.2dvh] flex flex-col justify-center items-center">
        <div className="flex w-full flex-col items-center justify-center px-4 md:px-6 text-center">
          <Reveal>
            <p
              className="text-sm font-semibold uppercase tracking-wide sm:text-xs md:text-sm lg:text-base"
            >
              Human | Designer - Developer | Innovator
            </p>
